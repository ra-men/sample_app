...
describe "UsersPages" do
  ...
  #   describe "some maliscious user" do
  #     let(:non_admin) { FactoryGirl.Create(:user) }
  #     before { sign_in non_admin }

  #     describe "edits his own profile" do
  #       before { visit edit_user_path(non_admin) }

  #       describe "submitting a post to set the admin flag" do
  #         let(params) { params[:user][:admin] == true }
  #         before { update user_path(non_admin) }
